...
from tests.helper.utils import update_config_json, update_profile_json
...
class TestMysqlSourceConfig:
    ...
    def test_invalid_profile(
        ...
        pipeline_config_dict = io_adapter.read(IoType.LOCAL_FILE_IO, file_path=base_config_json)
        updated_profiles_json = update_profile_json(update_data, base_profiles_json)
        profiles_dict = io_adapter.read(IoType.LOCAL_FILE_IO, file_path=updated_profiles_json)
    ...
    def test_incremental_interval_from_overwrite_source_query_1(
        ...
        expected = "TIMESTAMP(time) > CONVERT_TZ('2022-12-31 23:50:00', 'Asia/Tokyo', 'Asia/Tokyo')"
    ...
    def test_incremental_interval_from_overwrite_source_query_3(
        ...
        expected = "TIMESTAMP(time) > CONVERT_TZ('2022-12-31 00:00:00', 'Asia/Tokyo', 'Asia/Tokyo')"
    ...
    def test_incremental_interval_from_overwrite_source_query_5(
        ...
        expected = "TIMESTAMP(day) > CONVERT_TZ('2022-12-12 23:59:59', 'Asia/Tokyo', 'Asia/Tokyo')"
    ...
    def test_incremental_interval_from_overwrite_source_query_7(
        ...
        expected = "TIMESTAMP(time) > CONVERT_TZ('2022-12-31 14:00:00', 'Asia/Tokyo', 'Asia/Tokyo')"
    ...
    def test_incremental_interval_from_overwrite_source_query_9(
        ...
        expected = "TIMESTAMP(time) > CONVERT_TZ('2022-12-22 23:59:59', 'Asia/Tokyo', 'Asia/Tokyo')"
